...
\[ \text{House\_Price\_Index} = \beta_0 + \beta_1 \times \text{Inflation\_Rate} + \beta_2 \times \text{Interest\_Rate} + \beta_3 \times \text{Unemployment\_Rate} + \beta_4 \times \text{Immigration\_numbers} + \beta_5 \times \text{Housing\_Starts} + \epsilon \]
...
The model suggests interest rate as a significant predictor of HPI
